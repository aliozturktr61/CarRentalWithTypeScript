...
// Fonksiyon asenkron olduğundan ve bir return değerine sahip olduğundan dolayo return tipini belirlerken 
//sadece return edilen tipi "CarType[]" ifade etmek yerine bu fonksiyonun hata da döndürebilecğeinden 
//ve asenkdron olduğunda dolayı bu tipi react'ın içerisnde bulnan 
